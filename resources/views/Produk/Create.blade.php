...
<div class="mb-3">
 <label class="formlabel">Deskripsi</label>
<textarea name="deskripsi" class="formcontrol" rows="3"></textarea>
</div>
 <div class="mb-3">
 <label class="form-label">StokAwal</label>
 <!-- Nilai default 0 jika dibiarkan -->
 <input type="number" name="stok"value="0" class="form-control">
 </div>
<button type="submit" class="btn btnsuccess">Simpan Data</button>
 <a href="/produk" class="btn btnsecondary">Batal / Kembali</a>
</form> --}}
